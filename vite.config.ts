...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      // ============ 通用 API 代理（匹配代码中的 /api/proxy/* 格式）============
      '/api/proxy/qqmusic_c': {
        target: 'https://c.y.qq.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/qqmusic_c/, ''),
        headers: { ...commonHeaders, referer: 'https://y.qq.com/', origin: 'https://y.qq.com' },
      },
      '/api/proxy/qqmusic_u': {
        target: 'https://u.y.qq.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/qqmusic_u/, ''),
        headers: { ...commonHeaders, referer: 'https://y.qq.com/', origin: 'https://y.qq.com' },
      },
      '/api/proxy/qqmusic_i': {
        ...
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace(/^\/api\/proxy\/qqmusic_i/, ''),
        headers: { ...commonHeaders, referer: 'https://y.qq.com/', origin: 'https://y.qq.com' },
      },
      '/api/proxy/netease': {
        target: 'https://music.163.com',
      ...
      '/api/proxy/netease_interface': {
        target: 'https://interface.music.163.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/netease_interface/, ''),
        headers: { ...commonHeaders, referer: 'https://music.163.com/' },
      },
      '/api/proxy/netease_interface3': {
        target: 'https://interface3.music.163.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/netease_interface3/, ''),
        headers: { ...commonHeaders, referer: 'https://music.163.com/' },
      },
      '/api/proxy/netease_y': {
        target: 'https://y.music.163.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/netease_y/, ''),
        headers: { ...commonHeaders, referer: 'https://music.163.com/' },
      },
      '/api/proxy/kuwo_search': {
        target: 'https://search.kuwo.cn',
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kuwo_search/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kuwo.cn/' },
      },
      '/api/proxy/kuwo_m': {
        target: 'https://m.kuwo.cn',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kuwo_m/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kuwo.cn/' },
      },
      '/api/proxy/kuwo_wapi': {
        ...
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kuwo_wapi/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kuwo.cn/' },
      },
      '/api/proxy/kuwo_kbang': {
        target: 'https://kbangserver.kuwo.cn',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kuwo_kbang/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kuwo.cn/' },
      },
      '/api/proxy/kuwo_npl': {
        target: 'https://nplserver.kuwo.cn',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kuwo_npl/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kuwo.cn/' },
      },
      '/api/proxy/kuwo_mobile': {
        target: 'https://mobileinterfaces.kuwo.cn',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kuwo_mobile/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kuwo.cn/' },
      },
      '/api/proxy/kuwo_nmobi': {
        target: 'https://nmobi.kuwo.cn',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kuwo_nmobi/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kuwo.cn/' },
      },
      '/api/proxy/kugou_search': {
        target: 'https://msearch.kugou.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kugou_search/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kugou.com/' },
      },
      '/api/proxy/kugou_mobilecdn': {
        target: 'https://mobilecdn.kugou.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kugou_mobilecdn/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kugou.com/' },
      },
      '/api/proxy/kugou_mobilecdnbj': {
        target: 'https://mobilecdnbj.kugou.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kugou_mobilecdnbj/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kugou.com/' },
      },
      '/api/proxy/kugou_lyrics': {
        target: 'https://lyrics.kugou.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kugou_lyrics/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kugou.com/' },
      },
      '/api/proxy/kugou_t': {
        target: 'https://t.kugou.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kugou_t/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kugou.com/' },
      },
      '/api/proxy/kugou_www2': {
        target: 'https://www2.kugou.kugou.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kugou_www2/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kugou.com/' },
      },
      '/api/proxy/kugou_gateway': {
        target: 'https://gateway.kugou.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kugou_gateway/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kugou.com/' },
      },
      '/api/proxy/kugou_songsearch': {
        target: 'https://songsearch.kugou.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kugou_songsearch/, ''),
        headers: { ...commonHeaders, referer: 'https://www.kugou.com/' },
      },
      '/api/proxy/bili': {
        target: 'https://www.bilibili.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/bili/, ''),
        headers: { ...commonHeaders, referer: 'https://www.bilibili.com/' },
      },
      '/api/proxy/biliapi': {
        target: 'https://api.bilibili.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/biliapi/, ''),
        headers: { ...commonHeaders, referer: 'https://www.bilibili.com/' },
      },
      '/api/proxy/haitang': {
        target: 'http://musicapi.haitangw.net',
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace(/^\/api\/proxy\/haitang/, ''),
        headers: { ...commonHeaders },
      },
      '/api/proxy/haitangm': {
        target: 'http://music.haitangw.net',
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace(/^\/api\/proxy\/haitangm/, ''),
        headers: { ...commonHeaders },
      },
      '/api/proxy/lxmusic': {
        target: 'https://lxmusicapi.onrender.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/lxmusic/, ''),
        headers: { ...commonHeaders },
      },
      '/api/proxy/ikun': {
        target: 'https://api.ikunshare.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/ikun/, ''),
        headers: { ...commonHeaders },
      },
      '/api/proxy/haitangcc': {
        target: 'https://music.haitangw.cc',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/haitangcc/, ''),
        headers: { ...commonHeaders, referer: 'https://music.haitangw.cc/' },
      },
      '/api/proxy/duanx': {
        target: 'https://share.duanx.cn',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/duanx/, ''),
        headers: { ...commonHeaders },
      },
      '/api/proxy/migu_m': {
        target: 'https://m.music.migu.cn',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/migu_m/, ''),
        headers: { ...commonHeaders, referer: 'https://music.migu.cn/' },
      },
      '/api/proxy/migu': {
        target: 'https://music.migu.cn',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/migu/, ''),
        headers: { ...commonHeaders, referer: 'https://music.migu.cn/' },
      },
      '/api/proxy/migu_cdn': {
      ...
      '/api/proxy/kstore': {
        ...
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/kstore/, ''),
        headers: { ...commonHeaders },
      },
      '/api/proxy/gitee': {
        target: 'https://gitee.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/gitee/, ''),
        headers: { ...commonHeaders, referer: 'https://gitee.com/' },
      },
      '/api/proxy/github': {
        target: 'https://raw.githubusercontent.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/github/, ''),
        headers: { ...commonHeaders },
      },
      '/api/proxy/jsdelivr': {
        target: 'https://fastly.jsdelivr.net',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/jsdelivr/, ''),
        headers: { ...commonHeaders },
      },
    },
  },
